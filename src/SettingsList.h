...
inline const std::vector<SettingInfo>& getSettingsList() {
  static const std::vector<SettingInfo> list = {
      ...
      SettingInfo::ValueU16(StrId::STR_MARGIN_TOP, &CrossPointSettings::screenMarginTop, {5, 355, 5},
                            "screenMarginTop", StrId::STR_CAT_READER),
      SettingInfo::ValueU16(StrId::STR_MARGIN_RIGHT, &CrossPointSettings::screenMarginRight, {5, 355, 5},
                            "screenMarginRight", StrId::STR_CAT_READER),
      SettingInfo::ValueU16(StrId::STR_MARGIN_BOTTOM, &CrossPointSettings::screenMarginBottom, {5, 355, 5},
                            "screenMarginBottom", StrId::STR_CAT_READER),
      SettingInfo::ValueU16(StrId::STR_MARGIN_LEFT, &CrossPointSettings::screenMarginLeft, {5, 355, 5},
                            "screenMarginLeft", StrId::STR_CAT_READER),
